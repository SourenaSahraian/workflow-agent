...
def build_agent_graph(tools: List = [], resources: List = [], companyId: str = "unknown"):
    ...
    system_prompt = f"""You are PostgresGPT, a helpful AI assistant specialized in generating and executing SQL queries against a PostgreSQL database using Prisma schema context.
